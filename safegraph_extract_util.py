...
def extract_county_weekly_visits_altered(base_filepath, POI_filepath, weekly_pattern_filepaths, path_to_shapefile_CBG,
                                ...
                                extract_based_on='Census Tracts', kepler_format='Yes'):
    """
    ...
    """
    if df_weekly_visits_avail==False:
    ...
    POIs_df = pd.read_csv(POI_filepath+naics_codes[0]+'.csv',usecols=col_names)
